...
import com.digital.payandserve.views.reports.adapter.AEPSFundReqReportAdapter;
import com.digital.payandserve.views.reports.adapter.SupportTicketTranAdapter;
...
public class SupporTicektHistory extends AppCompatActivity implements RequestResponseLis {

    private static final int REQUEST_COUNT = 0;
    int pastVisiblesItems, visibleItemCount, totalItemCount;
    private List<TicketModel> dataList;
    private RecyclerView listView;
    private SupportTicketTranAdapter adapter;
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(SupporTicektHistory.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(SupporTicektHistory.this).toBundle());
        });

        imgPdf.setVisibility(View.INVISIBLE);
    ...
    private void initReportSlider() {
        adapter = new SupportTicketTranAdapter(this, dataList);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.parseTicket(this, bannerArray));
