...
import com.digital.payandserve.views.reports.adapter.IdStockAdapter;
...
public class IdStockReport extends AppCompatActivity implements RequestResponseLis {

    private static final int REQUEST_COUNT = 0;
    int pastVisiblesItems, visibleItemCount, totalItemCount;
    private List<IdStockModel> dataList;
    private RecyclerView listView;
    private IdStockAdapter adapter;
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(IdStockReport.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(IdStockReport.this).toBundle());
        });
...
//        imgPdf.setOnClickListener(v -> initReportPDFData());
    ...
    private void initReportSlider() {
        adapter = new IdStockAdapter(this, dataList);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.parseIdStock(idStockArray));
...
/*
    ...
    private void initReportPDFData() {
        ...
        for (IdStockModel model : dataList) {
