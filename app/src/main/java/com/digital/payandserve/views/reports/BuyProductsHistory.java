...
import com.digital.payandserve.views.invoice.PdfManager2;
...
import com.digital.payandserve.views.reports.adapter.BuyProductAdapter;
...
public class BuyProductsHistory extends AppCompatActivity implements RequestResponseLis {
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(BuyProductsHistory.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(BuyProductsHistory.this).toBundle());
        });
    ...
    private void initReportSlider() {
        adapter = new BuyProductAdapter(this, dataList);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.BuyProductParseTransaction(this, bannerArray));
    ...
    private void initReportPDFData() {
        String[] keys = {"ID", "Number", "Price", "Product", "Date", "Status"};
        List<List<InvoiceModel>> modelList = new ArrayList<>();
        for (BuyProductModel model : dataList) {
            ...
            invoiceModels.add(new InvoiceModel("Price", model.getPrice()));
            invoiceModels.add(new InvoiceModel("Product", model.getProduct()));
