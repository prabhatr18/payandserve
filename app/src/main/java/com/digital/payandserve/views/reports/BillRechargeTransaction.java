...
import com.digital.payandserve.views.reports.adapter.BillTranAdapter;
...
public class BillRechargeTransaction extends AppCompatActivity implements RequestResponseLis {
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            ...
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(
                    BillRechargeTransaction.this).toBundle());
        });
    ...
    private void initReportPDFData() {
        String[] keys = {"ID", "Number", "Amount", "Charge", "Balance", "Via", "Trans Type",
