...
import com.digital.payandserve.views.reports.adapter.CashbackAdapter;
...
public class CashbackStatmentReport extends AppCompatActivity implements RequestResponseLis {
    ...
    private void initToolbar() {
        ...
        imgFilter.setOnClickListener(v -> {
            Intent i = new Intent(CashbackStatmentReport.this, FilterView.class);
            startActivity(i, ActivityOptions.makeSceneTransitionAnimation(CashbackStatmentReport.this).toBundle());
        });
...
//        imgPdf.setOnClickListener(v -> initReportPDFData());
    ...
    private void initReportSlider() {
        adapter = new CashbackAdapter(this, dataList);
    ...
    public void onSuccessRequest(String JSonResponse) {
        ...
        try {
            ...
            if (object.has("data")) {
                ...
                dataList.addAll(AppHandler.parseCashbackList(idStockArray));
...
/*
    ...
    private void initReportPDFData() {
        ...
        for (CashbackModel model : dataList) {
