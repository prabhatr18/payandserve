...
import com.digital.payandserve.posprinter.PrintRasterImage.dither;
...
//
    ...
    public void printImageThreeInch(Bitmap originalBitmap) throws IOException {
        Bitmap resizedBitmap = Bitmap.createScaledBitmap(originalBitmap, 577, originalBitmap.getHeight(), false); // 577
