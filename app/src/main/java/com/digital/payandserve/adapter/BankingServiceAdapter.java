...
public class BankingServiceAdapter extends RecyclerView.Adapter<BankingServiceAdapter.ViewHolder> {

    private Context context;
    private List<ActivityListModel> activityListModels;

    public BankingServiceAdapter(Context context, List<ActivityListModel> activityListModels) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.our_service_item, parent, false);
